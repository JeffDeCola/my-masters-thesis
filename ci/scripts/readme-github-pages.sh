#!/bin/sh
# my-masters-thesis readme-github-pages.sh
...
echo "The goal is to git clone /my-masters-thesis to /my-masters-thesis-updated"
...
echo "   /my-masters-thesis"
echo "   /my-masters-thesis-updated (created in task-build-push.yml task file)"
echo " "
...
echo "git clone my-masters-thesis to my-masters-thesis-updated"
git clone my-masters-thesis my-masters-thesis-updated
echo " "

echo "cd my-masters-thesis-updated"
cd my-masters-thesis-updated
echo " "
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-masters-thesis\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-masters-thesis\/master\/svgs\//g' temp-README.md
echo " "

...
. crrcmts . Application used for a Specific . particular Inte gra t e d application.c· rrcm
Automatic Test Generation -Software used to help generate test vectors.